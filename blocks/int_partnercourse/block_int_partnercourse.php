...
class block_int_partnercourse extends block_base {
    ...
    public function get_content() {
        ...
        $this->content->text .= '<a href="'.$CFG->wwwroot.'/blocks/int_partnercourse/enrol.php" title="'. $str .'">'.$str.'</a>';      
        $this->content->text .= "</li>\n"; 
        ...
        $this->content->text .= '<a href="'.$CFG->wwwroot.'/blocks/int_partnercourse/courses.php" title="'. $str .'">'.$str.'</a>';
        $this->content->text .= "</li>\n";   
